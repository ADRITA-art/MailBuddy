...
export default function MailForm() {
  ...
  return (
    <div
      className="min-h-screen flex flex-col items-center justify-center px-4 md:px-8 lg:px-16 relative"
      style={{
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden z-[-1] md:z-0">
        ...
        <div className="w-48 h-48 bg-gradient-to-r from-purple-600 to-pink-400 rounded-full absolute -top-16 left-16 md:left-32 animate-pulse-slow rotate-[260deg]"></div>
      ...
      {/* Page Title */}
      <h1
        className="text-4xl md:text-5xl font-extrabold text-center mb-6 transition-all duration-300 hover:text-red-700 z-10"
        style={{
      ...
      {/* Form Container */}
      <div
        className="p-6 sm:p-8 md:p-10 border-2 border-gray-300 rounded-lg shadow-lg max-w-lg md:max-w-xl w-full transition-all duration-300 hover:shadow-2xl relative z-10"
        style={{
