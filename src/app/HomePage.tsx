...
const HomePage: React.FC = () => {
  ...
  return (
    <div
      className="min-h-screen bg-purple-200 flex flex-col justify-center items-center relative"
      style={{
    ...
    >
      {/* Title Section */}
      <h1
        className="text-5xl font-extrabold text-red-700 mb-12"
        style={{ color: "#B8001F" }}
      >
        Create Your Mail
      </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mt-10">
        {/* Cold Mailer */}
        <div
          className="group bg-gradient-to-r from-purple-800 to-purple-300 p-16 rounded-lg shadow-5xl border-2 border-black hover:scale-105 transition-all duration-200 cursor-pointer relative"
          onClick={() => handleMailerClick("Cold Mailer")}
          onMouseEnter={() => handleMouseEnter("Send a cold mail to make a connection.")}
          onMouseLeave={handleMouseLeave}
        >
          <h2 className="text-3xl font-bold text-yellow-200 mb-6">Cold Mailer</h2>
          <div className="group-hover:translate-x-2 transition-transform duration-200 text-white text-2xl">
            →
          </div>
        ...
        {/* Persuasive Mailer */}
        <div
          className="group bg-gradient-to-r from-purple-800 to-purple-300 p-16 rounded-lg shadow-xl border-2 border-black hover:scale-105 transition-all duration-200 cursor-pointer relative"
          onClick={() => handleMailerClick("Persuasive Mailer")}
          onMouseEnter={() => handleMouseEnter("Craft a persuasive mail to convince someone.")}
          onMouseLeave={handleMouseLeave}
        >
          <h2 className="text-3xl font-bold text-yellow-200 mb-6">Persuasive Mailer</h2>
          <div className="group-hover:translate-x-2 transition-transform duration-200 text-white text-2xl">
            →
          </div>
        ...
        <div
          ...
          onMouseLeave={handleMouseLeave}
        >
          <h2 className="text-3xl font-bold text-yellow-200 mb-6">Leave Mailer</h2>
          <div className="group-hover:translate-x-2 transition-transform duration-200 text-white text-2xl">
            →
          </div>
      ...
      {/* Footer Section */}
      <footer className="mt-16 text-center text-purple-900">
        Made with 💜 by Adrita
      </footer>
    </div>
  );
